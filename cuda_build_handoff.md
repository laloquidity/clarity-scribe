...
**Repo**: `c:\Users\alex\Downloads\clarity-scribe`
...
`c:\Users\alex\Downloads\clarity-scribe\node_modules\onnxruntime-node\bin\napi-v6\win32\x64\`

Replace the files there:
```powershell
$dest = "c:\Users\alex\Downloads\clarity-scribe\node_modules\onnxruntime-node\bin\napi-v6\win32\x64"
...
$appCuda = "c:\Users\alex\Downloads\clarity-scribe\resources\win-gpu\cuda"
...
File: `c:\Users\alex\Downloads\clarity-scribe\electron\parakeetService.ts`
...
File: `c:\Users\alex\Downloads\clarity-scribe\electron-builder.yml`
...
```powershell
cd c:\Users\alex\Downloads\clarity-scribe
npm run dev
```
